...
namespace WebResumen.Controllers
{
    ...
    public class AutoClaveCController : Controller
    {
        ...
        public AutoClaveCController(AppDbContext context, IPrinterOchoVeinte printerOchoVeinte, IPrinterDosTresCuatro printerDosTresCuatro, ILogRecord log, IHttpContextAccessor httpContextAccessor, IPrinterOchoVeinteAS printerOchoVeinteAS, IPrinterDosTresCuatroAS printerDosTresCuatroAS)
        {
            _context = context;
