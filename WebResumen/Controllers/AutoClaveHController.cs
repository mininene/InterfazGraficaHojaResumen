...
namespace WebResumen.Controllers
{
   // [Authorize(Policy = "ADTodos")]
    public class AutoClaveHController : Controller
    {
        ...
        public AutoClaveHController(AppDbContext context, IPrinterOchoVeinte printerOchoVeinte, IPrinterDosTresCuatro printerDosTresCuatro, ILogRecord log, IHttpContextAccessor httpContextAccessor, IPrinterOchoVeinteAS printerOchoVeinteAS, IPrinterDosTresCuatroAS printerDosTresCuatroAS)
        {
            _context = context;
        ...
        // GET: AutoClaveH/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AutoClaveH/Create
